...
public class PruebaPizza {
  public static void main(String[] args) {
    ...
    System.out.println("Pizza 1. Tamaño: " + pizza1.getTamanyo() + ", Tipo: " 
    + pizza1.getTipo() + ", Estado: " + pizza1.getEstado() + ", Coste: " + pizza1.coste());
    System.out.println("Pizza 2. Tamaño: " + pizza2.getTamanyo() + ", Tipo: " 
    + pizza2.getTipo() + ", Estado: " + pizza2.getEstado() + ", Coste: " + pizza2.coste());
    System.out.println("Pizza 3. Tamaño: " + pizza3.getTamanyo() + ", Tipo: " 
    + pizza3.getTipo() + ", Estado: " + pizza3.getEstado() + ", Coste: " + pizza3.coste());
