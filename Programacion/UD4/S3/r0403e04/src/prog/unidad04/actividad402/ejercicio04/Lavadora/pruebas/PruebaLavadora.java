package prog.unidad04.actividad402.ejercicio04.Lavadora.pruebas;

import prog.unidad04.actividad204.ejercicio04.Lavadora;
...
public class PruebaLavadora {
  ...
  public static void main(String[] args) {
    ...
    Lavadora lavadora3 = new Lavadora(650, "Azul", 'A', 75, 8);
  ...
  private static String obtenerCadenaLavadora(Lavadora lavadora) {
    return "Precio Base: " + lavadora.getPrecioBase() + ", Color: " + lavadora.getColor() + 
